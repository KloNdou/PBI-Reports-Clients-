...
## Tools
Power BI, DAX, Power Query, Data Modelling (Star Schema), Shopify Data

Led a 5-year performance review for an online Shopify store, building a structured data model in Power BI with 1 fact sales table, 5 dimension tables, and a dedicated date table to enable time-based analysis. Designed and deployed an interactive dashboard to monitor KPIs, seasonal trends, and customer behaviour.
